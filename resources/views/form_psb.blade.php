            ...
            <div class="sect">
                ...
                <div class="div">
                    ...
                    <input class="input" type="text" name="fullname" id="fullname"
                        placeholder="Masukkan nama calon peserta didik" minlength="3" maxlength="120" required>
                </div>
                <div class="div">
                    <label for="genderInput">Jenis Kelamin</label>
                    <div class="radio" id="genderRadioGroup">
                        <input type="hidden" id="genderInput" name="gender" value="male" required readonly>
                ...
                <div class="div">
                    ...
                    <input class="input" type="date" name="birth_date" id="birth_date" placeholder="" required>
                </div>
            </div>
            <div class="sect">
                <div class="div">
                    ...
                    <input class="input" type="email" name="email" id="email"
                        placeholder="Masukkan alamat email calon peserta didik" minlength="8" maxlength="120" required>
                </div>
                <div class="div">
                    <label for="no_telp">No Telp</label>
                    <input class="input" type="number" name="no_telp" id="no_telp"
                        placeholder="Masukkan no telepon calon peserta didik" minlength="11" maxlength="12" required>
                </div>
                <div class="div">
                ...
                <div class="div">
                    ...
                    <input class="input" type="text" name="prev_school" id="prev_school"
                        placeholder="Masukkan nama sekolah sebelumnya" minlength="8" maxlength="220" required>
                </div>
            </div>
        </div>
        <br>
            ...
            <div class="sect">
                <div class="div">
                    ...
                    <input class="input" type="text" name="parent_name" id="parent_name"
                        placeholder="Masukkan wali calon peserta didik" minlength="3" maxlength="120" required>
                </div>
                <div class="div">
                    <label for="parent_Telp">Nomor Telefon Wali</label>
                    <input class="input" type="text" name="parent_telp" id="parent_Telp"
                        placeholder="Masukkan nomor telepon wali" required>
                </div>
                <div class="div">
                    ...
                    <input class="input" type="text" name="parent_email" id="parent_email"
                        placeholder="Masukkan alamat email wali" minlength="8" maxlength="220">
                </div>
            </div>
            <div class="sect">
                <div class="div">
                    ...
                    <div class="radio" id="jurusanGroup">
                        <input type="hidden" id="jurusanInput" name="major" value="" readonly required>
                        <div>
